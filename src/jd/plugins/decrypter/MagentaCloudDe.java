...
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 3, names = { "magentacloud.de" }, urls = { "https?://(www\\.)?magentacloud\\.de/(share|lnk)/[a-z0-9\\-]+" }) public class MagentaCloudDe extends PluginForDecrypt {
