 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 38377 $", interfaceVersion = 2, names = { "coinlink.co" }, urls = { "https?://(?:www\\.)?(?:coinlink\\.co|adlink\\.guru|short\\.es|tmearn\\.com|cut-urls\\.com|ibly\\.co|adshort\\.(?:co|me|im)|brlink\\.in|urle\\.co|mitly\\.us|cutwin\\.com|cpmlink\\.net)/[A-Za-z0-9]+$" })
