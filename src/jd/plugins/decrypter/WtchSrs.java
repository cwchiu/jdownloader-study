 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 37814 $", interfaceVersion = 2, names = { "seriesfree.to" }, urls = { "https?://(?:www\\.)?(?:watchseries\\.ag|watchtvseries\\.(?:se|vc)|seriesfree.to)/(episode/.*?\\.html|open/cale/[a-z0-9-]+\\.html)" })
