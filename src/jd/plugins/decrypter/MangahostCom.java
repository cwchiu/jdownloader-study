...
@DecrypterPlugin(revision = "$Revision: 38649 $", interfaceVersion = 3, names = { "mangahost.com" }, urls = { "https?://(?:www\\.)?(?:br\\.)?(mangahost\\.(?:com|net|me|org|cc)|yesmangas\\.net|mangashost\\.(?:net|com)|mangahosts\\.com)/manga/[^/]+/([^\\s]*\\d+(\\.\\d+|[a-z])?|one-shot)" })
