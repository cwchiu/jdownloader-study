...
@DecrypterPlugin(revision = "$Revision: 38341 $", interfaceVersion = 2, names = { "israbox.life" }, urls = { "https?://[\\w\\.]*(?:israbox\\.(?:com|co|net|org|info|me|download|eu|be|club|life|pw|io|one)|isbox\\.net)/[0-9]+-.*?\\.html" })
