 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 36713 $", interfaceVersion = 3, names = { "safelinkconverter.com" }, urls = { "https?://(?:\\w+\\.)?(?:safelinkconverter\\.com/(?:index\\.php|review\\.php|noadsense\\.php|decrypt(?:-2)?/)?|safelinkreview\\.com/[a-z]{2}/\\w+/|getcomics\\.ga/[a-z]{2}/\\w+/[^\\?]+)\\?(?:.*?&)?id=([a-zA-Z0-9_/\\+\\=\\-%]+)[^\\s%]*" })
