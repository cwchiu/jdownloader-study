...
@DecrypterPlugin(revision = "$Revision: 37940 $", interfaceVersion = 3, names = { "crunchyroll.com" }, urls = { "http://(?:www.)?crunchyroll.com(?:.br)?/(?!forumtopic)(?:comics_read(?:/(?:manga|comipo|artistalley))?\\?(?:volume_id|series_id)=[0-9]+&chapter_num=[0-9]+\\.[0-9]+|[\\w_\\-]+/[\\w\\_\\-]+\\-[0-9]+)" })
