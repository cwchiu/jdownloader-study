...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 3, names = { "primejailbait.com" }, urls = { "https?://(?:www\\.)?(?:primejailbait\\.com|primejb\\.net)/(id/\\d+|profile/[A-Za-z0-9\\-_]+(?:/fav/\\d+)?|setview/\\d+)/?$" }) 
