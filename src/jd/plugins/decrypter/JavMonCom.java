...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "javmon.com" }, urls = { "https?://(www\\.)?(javmon|jamo)\\.(com|tv)/(online\\-\\d+/)?(video|movie|clip)\\-\\d+(/|\\-)[a-z0-9\\-_]+\\.html" }) 
