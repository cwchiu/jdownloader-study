...
@DecrypterPlugin(revision = "$Revision: 36989 $", interfaceVersion = 3, names = { "hightail.com" }, urls = { "https?://(?:www\\.)?(?:yousendit|hightail)\\.com/download/[A-Za-z0-9\\-_]+|https?://spaces\\.hightail\\.com/receive/[A-Za-z0-9]+/.+" })
