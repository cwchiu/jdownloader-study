 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 38009 $", interfaceVersion = 3, names = { "uploadid.net", "shortenurl.pw", "888.xirkle.com", "gempixel.com", "susutin.com", "short.awsubs.co" }, urls = { "https?://(?:www\\.)?uploadid\\.net/[a-zA-Z0-9]+", "https?://(?:www\\.)?shortenurl\\.pw/[a-zA-Z0-9]+", "https?://(?:www\\.)?888\\.xirkle\\.com/[a-zA-Z0-9]+", "https?://(?:www\\.)?gempixel\\.com/short/[a-zA-Z0-9]+", "https?://(?:www\\.)?susutin\\.com/[a-zA-Z0-9]+", "https?://(?:www\\.)?short\\.awsubs\\.co/[a-zA-Z0-9]+" })
