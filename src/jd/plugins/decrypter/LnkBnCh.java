 ...
 * @author raztoki
 */
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 3, names = { "linkbun.ch" }, urls = { "https?://(?:www\\.)?linkbun\\.ch/(?-i)[a-z0-9]{4,5}" }) 
public class LnkBnCh extends antiDDoSForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        final String plaintxt = br.getRegex("<p id=\"links\">(.*?)</p>").getMatch(0);
        if (plaintxt == null) {
