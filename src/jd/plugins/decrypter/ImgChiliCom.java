...
@DecrypterPlugin(revision = "$Revision: 38625 $", interfaceVersion = 2, names = { "imgchili.com" }, urls = { "https?://((www\\.)?imgchili\\.(com|net)/show/|(i|t)\\d+\\.imgchili\\.(com|net)/)\\d+/[a-z0-9_\\.\\(\\)%\\-]+|http://(www\\.)?imgchili\\.(com|net)/album/[a-z0-9]{32}" })
