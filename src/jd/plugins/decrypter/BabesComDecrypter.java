...
@DecrypterPlugin(revision = "$Revision: 35173 $", interfaceVersion = 2, names = { "babes.com" }, urls = { "https?://members\\.babes\\.com/(?:video/view/id/\\d+(?:/[a-z0-9\\-_]+/?)?|pictures/hqpics/id/\\d+(?:/[a-z0-9\\-_]+/?)?)" })
