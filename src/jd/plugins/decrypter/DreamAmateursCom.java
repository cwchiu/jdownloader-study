...
@DecrypterPlugin(revision = "$Revision: 37516 $", interfaceVersion = 3, names = { "dreamamateurs.com" }, urls = { "http://(www\\.)?dreamamateurs\\.com/(?:[A-Za-z0-9]+/\\d+/\\w+\\.html|link/\\d+/|\\d+/\\w+\\.html|\\w+/\\d+/\\w+)" })
