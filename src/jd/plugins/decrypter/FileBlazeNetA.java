...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "fileblaze.net" }, urls = { "https?://((www|betastage)\\.)?fileblaze\\.net/external(\\-(html|fileblaze))?\\.html\\?key=[0-9a-f]+|http://fblaz\\.in/\\w+" }) 
