...
@DecrypterPlugin(revision = "$Revision: 36313 $", interfaceVersion = 3, names = { "320k.me" }, urls = { "https?://(?:www\\.)?320k\\.(?:in|me)/index\\.php\\?surf=(viewupload(\\&groupid=\\d*)?\\&uploadid=\\d+|redirect\\&url=[A-Za-z0-9 %=]+(?:\\&uploadid=\\d+)?)" })
