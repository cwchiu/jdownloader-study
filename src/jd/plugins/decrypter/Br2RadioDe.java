...
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 3, names = { "br.de" }, urls = { "https?://(www\\.)?br\\.de/radio/bayern2/[^<>\"]+\\d+\\.html" }) public class Br2RadioDe extends PluginForDecrypt {
