 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 38592 $", interfaceVersion = 2, names = { "jerkplanet.org", "superload.me", "topcookbox.com" }, urls = { "https?://(www\\.)?jerkplanet\\.org/file/[0-9a-zA-Z]+", "(?:http://(www\\.)?superload\\.me|https://(?:www\\.)?superload\\.me(?:443)?)/file/[0-9a-zA-Z]+", "https?://(?:www\\.)?topcookbox\\.com/file/[0-9a-zA-Z]+" })
