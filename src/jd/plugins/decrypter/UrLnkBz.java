 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 2, names = { "urlink.biz" }, urls = { "https?://(?:www\\.)?(?:urlink\\.biz|ur-link\\.biz|url-ink\\.biz|url-ink\\.com|urli-nk\\.com)/[A-Za-z0-9]{4,6}" })
