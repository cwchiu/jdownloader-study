...
@DecrypterPlugin(revision = "$Revision: 38122 $", interfaceVersion = 2, names = { "sexuria.com" }, urls = { "https?://(www\\.)?sexuria\\.(com|to)/(v1/)?Pornos_Kostenlos_.+?_(\\d+)\\.html|https?://(www\\.)?sexuria\\.(com|to)/(v1/)?dl_links_\\d+_\\d+\\.html|https?://(www\\.)?sexuria\\.(com|to)/out\\.php\\?id=([0-9]+)\\&part=[0-9]+\\&link=[0-9]+" })
