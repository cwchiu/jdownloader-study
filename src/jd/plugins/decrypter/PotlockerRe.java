 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 35529 $", interfaceVersion = 3, names = { "potlocker.me" }, urls = { "http://(www\\.)?potlocker\\.(net/[a-z0-9\\-]+/\\d{4}/[a-z0-9\\-]+\\.html|(re|me)/[a-z0-9\\-_]+_[a-f0-9]{9}\\.html|me/embed\\.php\\?vid=[a-z0-9\\-]+)" })
