...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "audiomack.com" }, urls = { "http://(www\\.)?audiomack\\.com/(?:embed\\d-)?(?:album|large)/[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+" }) 
