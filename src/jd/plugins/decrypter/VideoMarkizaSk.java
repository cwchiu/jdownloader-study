 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, urls = { "http://video\\.markiza\\.sk/archiv\\-tv\\-markiza/[\\-a-z0-9]+/[0-9]+", "http://doma\\.markiza\\.sk/archiv\\-doma/[\\-a-z0-9]+/[0-9]+", "http://video\\.markiza\\.sk/(mini\\-music\\-tv|fun\\-tv)/[0-9]+/[\\-a-z0-9]+/[0-9]+", "http://(www\\.)?markiza\\.sk/clanok/aktualne/[^<>\"]*?\\.html" }, names = { "video.markiza.sk", "doma.markiza.sk", "video.markiza.sk", "video.markiza.sk" })
