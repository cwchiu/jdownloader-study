...
@DecrypterPlugin(revision = "$Revision: 38513 $", interfaceVersion = 3, names = { "perfectgirls.net" }, urls = { "http://([a-z]+\\.)?(perfectgirls\\.net/\\d+/|(www|ipad|m)\\.perfectgirls\\.net/gal/\\d+/.{0,1})" })
