...
@DecrypterPlugin(revision = "$Revision: 35766 $", interfaceVersion = 2, names = { "spiegel.de", "spon.de" }, urls = { "https?://(?:www\\.)?spiegel\\.de/(?:fotostrecke/[a-z0-9\\-]+\\d+(\\-\\d+)?\\.html|artikel/a\\-\\d+\\.html)", "https?://(?:www\\.)?spon\\.de/[A-Za-z0-9]+" })
