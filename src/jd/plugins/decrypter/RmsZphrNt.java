...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "roms.zophar.net" }, urls = { "http://(www\\.)?zophar\\.net/(?!download_file|frontends|news\\-archive|consoles)[^<>\"/]*?/[^<>\"/]*?/[^<>\"/]*?\\.html" }) 
