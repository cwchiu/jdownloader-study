...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "oboom.com" }, urls = { "https?://(www\\.)?oboom\\.com/(#share/[a-f0-9\\-]+|#?folder/[A-Z0-9]+)" }) public class OBoomCom extends antiDDoSForDecrypt {
