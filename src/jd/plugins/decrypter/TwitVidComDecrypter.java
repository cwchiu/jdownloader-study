...
@DecrypterPlugin(revision = "$Revision: 37427 $", interfaceVersion = 2, names = { "telly.com" }, urls = { "http://(www\\.)?(telly|twitvid)\\.com/(?!awesome|post|best|funnyimpressions|http|https|index|javascript|redirect)[A-Za-z0-9\\-]+" })
