...
@DecrypterPlugin(revision = "$Revision: 37967 $", interfaceVersion = 3, names = { "kprotector.com", "keeplinks.me" }, urls = { "https?://(www\\.)?kprotector\\.com/(p\\d*|d)/[a-z0-9]+", "https?://(www\\.)?keeplinks\\.(me|eu|co)/(p\\d*|d)/[a-z0-9]+" })
