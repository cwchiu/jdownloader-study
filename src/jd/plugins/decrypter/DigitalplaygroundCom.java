...
@DecrypterPlugin(revision = "$Revision: 36245 $", interfaceVersion = 2, names = { "digitalplayground.com" }, urls = { "https?://ma\\.digitalplayground\\.com/(?!model/)[a-z]+(?:/[a-z]+)?/\\d+(?:/[a-z0-9\\-_]+/?)?|https?://ma\\.digitalplayground\\.com/[^/]+/galleries/\\d+(?:/[a-z0-9\\-_]+/?)?|https?://www\\.digitalplayground\\.com/[a-z]+(?:/[a-z]+)?/trailer/\\d+/[a-z0-9\\-_]+/?" })
