...
@DecrypterPlugin(revision = "$Revision: 38217 $", interfaceVersion = 3, names = { "pan.baidu.com" }, urls = { "https?://(?:www\\.)?(?:pan|yun)\\.baidu\\.com/(?:share|wap)/.+|https?://(?:www\\.)?pan\\.baidu\\.com/s/[A-Za-z0-9]+(\\?linkpassword=[^#&]+)?(?:#(dir|list)/path=%2F.+)?" })
