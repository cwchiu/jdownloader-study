...
@DecrypterPlugin(revision = "$Revision: 36931 $", interfaceVersion = 2, names = { "bangbros.com" }, urls = { "https?://members\\.bangbros\\.com/product/\\d+/movie/\\d+|https?://bangbrothers\\.(?:com|net)/video\\d+/[a-z0-9\\-]+" })
