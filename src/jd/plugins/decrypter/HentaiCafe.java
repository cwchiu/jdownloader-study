...
@DecrypterPlugin(revision = "$Revision: 38504 $", interfaceVersion = 3, names = { "hentai.cafe" }, urls = { "https?://(?:www\\.)?hentai\\.cafe/(?:manga/read/[a-z0-9\\-_]+/[a-z]{2}/\\d+/\\d+/|(?!artists/|78-2/|category/)[\\w\\-]+/$)" })
