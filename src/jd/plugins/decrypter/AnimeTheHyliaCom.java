...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 3, names = { "anime.thehylia.com" }, urls = { "http://(www\\.)?anime\\.thehylia\\.com/(downloads/series/|soundtracks/album/)[a-z0-9\\-_]+" }) 
