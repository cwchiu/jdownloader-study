 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 36635 $", interfaceVersion = 3, names = { "rawfile.co", "sharelinked.com", "sharelinked.net" }, urls = { "https?://(?:www\\.)?rawfile\\.co/\\?p=(\\d+)", "https?://(?:www\\.)?sharelinked\\.com/\\?p=(\\d+)", "https?://(?:www\\.)?sharelinked\\.net/\\?p=(\\d+)" })
