...
@DecrypterPlugin(revision = "$Revision: 35387 $", interfaceVersion = 2, names = { "fantasymassage.com" }, urls = { "https?://members\\.fantasymassage\\.com/[a-z]{2}/(?:video|picture)//[A-Za-z0-9\\-_]+/\\d+|https?://members\\.fantasymassage\\.com/[a-z]{2}/pornstar//\\d+/[A-Za-z0-9\\-_]+" })
