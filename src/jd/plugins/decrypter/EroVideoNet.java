...
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 3, names = { "ero-video.net" }, urls = { "https?://(?:www\\.)?ero\\-video\\.net/movie/\\?mcd=[A-Za-z0-9]+" }) public class EroVideoNet extends PornEmbedParser {
