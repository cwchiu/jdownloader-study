...
@DecrypterPlugin(revision = "$Revision: 38217 $", interfaceVersion = 2, names = { "relink.us" }, urls = { "https?://(www\\.)?relink\\.(?:us|to)/(?:(f/|(go|view|container_captcha)\\.php\\?id=)[0-9a-f]{30}|f/linkcrypt[0-9a-z]{15}|f/[a-f0-9]{10})" })
