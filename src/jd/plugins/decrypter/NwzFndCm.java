...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "newzfind.com" }, urls = { "http://[\\w\\.]*?newzfind\\.com/(video|music|games|software|mac|graphics|unix|magazines|e-books|xxx|other)/.+" }) 
