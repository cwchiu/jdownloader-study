...
@DecrypterPlugin(revision = "$Revision: 36677 $", interfaceVersion = 2, names = { "mofos.com" }, urls = { "https?://members\\d+\\.mofos\\.com/(?:scene/view/\\d+(?:/[a-z0-9\\-_]+/?)?|hqpics/\\d+(?:/[a-z0-9\\-_]+/?)?)|https?://(?:www\\.)?mofos\\.com/tour/scene/[a-z0-9\\-]+/\\d+/?" })
