 ...
 *
 */
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 2, names = { "audiocastle.net" }, urls = { "https?://(www\\.)?(?:audiocastle\\.(?:net|co|me|is)|audiocastle2\\.biz)/(tracks|albums|mixtapes|immortals|videos)/view/\\d+" })
