...
@DecrypterPlugin(revision = "$Revision: 38135 $", interfaceVersion = 2, names = { "worldstarhiphop.com" }, urls = { "https?://(www\\.)?worldstarhiphop\\.com/videos/video(\\d+)?\\.php\\?v=[a-zA-Z0-9]+" })
