...
@DecrypterPlugin(revision = "$Revision: 36506 $", interfaceVersion = 3, names = { "mangastream.com" }, urls = { "https?://(?:www\\.)?(?:mangastream\\.com|readms\\.(?:com|net))/(read|r)/([a-z0-9\\-_%\\+\\.]+/){2}\\d+(\\?page=\\d+)?" })
