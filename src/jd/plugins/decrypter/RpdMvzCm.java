...
@DecrypterPlugin(revision = "$Revision: 37740 $", interfaceVersion = 2, names = { "rapidmoviez.com" }, urls = { "https?://(www\\.)?(?:rapidmoviez\\.com|rmz\\.rezavn|rmz\\.cr|rapidmoviez\\.eu)/release/[a-z0-9\\-]+" })
