...
@DecrypterPlugin(revision = "$Revision: 34936 $", interfaceVersion = 2, names = { "homemade-voyeur.com" }, urls = { "http://(?:www\\.)?(homemade\\-voyeur|yourvoyeurvideos)\\.com/(?:(?:tube/)?video/|tube/gallery/|\\d+/)[A-Za-z0-9\\-]+\\.html" })
