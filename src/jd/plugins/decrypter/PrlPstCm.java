 ...
 * @author raztoki
 * */
@DecrypterPlugin(revision = "$Revision: 36558 $", interfaceVersion = 2, names = { "prialepaste.com", "anonymizer.link" }, urls = { "https?://[\\w\\.]*prialepaste\\.com/(f[a-z]{0,1}\\.php#[a-zA-Z0-9\\+-/=]+|p/[A-Z0-9]{8})", "https?://[\\w\\.]*anonymizer\\.link/(f[a-z]{0,1}\\.php#[a-zA-Z0-9\\+-/=]+|p/[A-Z0-9]{8})" }) 
