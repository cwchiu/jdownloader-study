 ...
 * @author typek_pb
 */
@HostPlugin(revision = "$Revision: 36379 $", interfaceVersion = 2, names = { "break.com" }, urls = { "http://(www\\.)?breakdecrypted\\.com/(index|usercontent|skittles|video)/[A-Za-z0-9\\-_/]+\\-\\d+$" })
public class BreakCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws Exception {
        ...
        if (br.getURL().contains("break.com/content/missing/") || br.containsHTML("\"videoUri\": \"\"") || !br.containsHTML("embedVars")) {
