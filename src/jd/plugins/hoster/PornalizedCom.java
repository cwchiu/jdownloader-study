...
@HostPlugin(revision = "$Revision: 36868 $", interfaceVersion = 3, names = { "pornalized.com" }, urls = { "https?://(?:www\\.)?pornalized\\.com/videos/\\d+/[a-z0-9\\-]+" })
public class PornalizedCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        dllink = br.getRegex("\\'(?:file|sourceMp4)\\'[\t\n\r ]*?:[\t\n\r ]*?\\'(http[^<>\"]*?)\\'").getMatch(0);
        if (dllink == null) {
