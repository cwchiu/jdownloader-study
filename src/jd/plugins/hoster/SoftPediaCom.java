...
@HostPlugin(revision = "$Revision: 37922 $", interfaceVersion = 2, names = { "softpedia.com" }, urls = { "http://(www\\.|drivers\\.)?softpedia\\.com/(get/.+/.*?\\.shtml|progDownload/.*?\\-download\\-\\d+\\.(s)?html)" })
