...
@HostPlugin(revision = "$Revision: 36050 $", interfaceVersion = 2, names = { "met-art.com", "sexart.com" }, urls = { "https?://members\\.met-art\\.com/members/(media/.+|movie\\.php.+|movie\\.mp4.+|zip\\.php\\?zip=[A-Z0-9]+\\&type=(high|med|low))|decryptedmetartcom://.+", "decryptedsexartcom://.+" })
