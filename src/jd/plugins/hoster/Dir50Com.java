...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "dir50.com" }, urls = { "https?://(?:www\\.)?dir50\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class Dir50Com extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://dir50.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:dir50\\.com)";
    ...
    public Dir50Com(PluginWrapper wrapper) {
        super(wrapper);
