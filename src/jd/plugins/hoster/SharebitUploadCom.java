...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "sharebit-upload.com" }, urls = { "https?://(?:www\\.)?sharebit\\-upload\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class SharebitUploadCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://sharebit-upload.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:sharebit\\-upload\\.com)";
    ...
    public SharebitUploadCom(PluginWrapper wrapper) {
        super(wrapper);
