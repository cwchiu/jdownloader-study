...
@HostPlugin(revision = "$Revision: 38494 $", interfaceVersion = 2, names = { "moviefap.com" }, urls = { "https?://(www\\.)?moviefap\\.com/(videos/[a-z0-9]+/[a-z0-9\\-_]+\\.html|embedding_player/embedding_feed\\.php\\?viewkey=[a-z0-9]+)" })
