...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "uploadx.org" }, urls = { "https?://(?:www\\.)?uploadx\\.(?:org|co)/(?:embed\\-)?[a-z0-9]{12}" })
public class UploadxOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://uploadx.org";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(uploadx\\.org|uploadx\\.co)";
    ...
    public UploadxOrg(PluginWrapper wrapper) {
        super(wrapper);
