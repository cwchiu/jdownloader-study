...
@HostPlugin(revision = "$Revision: 35892 $", interfaceVersion = 3, names = { "coreimg.net" }, urls = { "https?://(?:www\\.)?coreimg\\.net/(?:embed\\-)?[a-z0-9]{12}" })
public class CoreimgNet extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://coreimg.net";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(coreimg\\.net)";
    ...
    public CoreimgNet(PluginWrapper wrapper) {
        super(wrapper);
