...
@HostPlugin(revision = "$Revision: 38262 $", interfaceVersion = 3, names = { "tokyomotion.net", "osakamotion.net" }, urls = { "https?://(?:www\\.)?tokyomotion\\.net/video/\\d+(?:/[^/]+)?", "https?://(?:www\\.)?osakamotion\\.net/video/\\d+(?:/[^/]+)?" })
