...
@HostPlugin(revision = "$Revision: 36922 $", interfaceVersion = 2, names = { "freefile.me" }, urls = { "https?://(?:www\\.)?freefile\\.me/[A-Za-z0-9]+" })
public class FreefileMe extends antiDDoSForHost {
     ...
     * mods: fetchAccountInfo[Special RegEx for German language]<br />
     * limit-info:<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://freefile.me";
    private final String                   domains                                      = "(freefile\\.me)";
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (!br.containsHTML("class=\"badge badge\\-success\">(?:PAID USER|USUARIO DE PAGO|BEZAHLT BENUTZER)</span>")) {
