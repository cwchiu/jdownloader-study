...
@HostPlugin(revision = "$Revision: 36193 $", interfaceVersion = 2, names = { "spiegel.de", "spiegel.tv" }, urls = { "https?://cdn\\d+\\.spiegel\\.de/images/image[^<>\"/]+|https?://(?:www\\.)?spiegel\\.de/video/(?:embedurl/)?[a-z0-9\\-_]*?video\\-[a-z0-9\\-_]*?\\.html", "https?://(?:www\\.)?spiegel\\.tv/.*?filme/[a-z0-9\\-]+/|https?://(?:www\\.)?spiegel\\.de/sptv/spiegeltv/[A-Za-z0-9\\-]+\\-\\d+\\.html" })
