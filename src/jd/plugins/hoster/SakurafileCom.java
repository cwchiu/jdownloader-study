...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "sakurafile.com" }, urls = { "https?://(?:www\\.)?sakurafile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class SakurafileCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://sakurafile.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(sakurafile\\.com)";
     ...
     * mods:<br />
     * limit-info: 2017-02-28: Premium untested, set FREE account limits<br />
    ...
    public SakurafileCom(PluginWrapper wrapper) {
        super(wrapper);
