...
@HostPlugin(revision = "$Revision: 35221 $", interfaceVersion = 3, names = { "media4up.com" }, urls = { "https?://(?:www\\.)?(?:media4up|gboxes)\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class Media4upCom extends PluginForHost {
    ...
    public String rewriteHost(String host) {
        if ("gboxes.com".equals(getHost())) {
            if (host == null || "gboxes.com".equals(host)) {
                return "media4up.com";
            }
        }
