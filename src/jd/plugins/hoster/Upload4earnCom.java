...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "upload4earn.com" }, urls = { "https?://(?:www\\.)?upload4earn\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class Upload4earnCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://upload4earn.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:upload4earn\\.com)";
     ...
     ****************************
     * mods:<br />
     * limit-info: 2018-02-09: Premium untested, set FREE limits<br />
    ...
    public Upload4earnCom(PluginWrapper wrapper) {
        super(wrapper);
