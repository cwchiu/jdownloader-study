...
@HostPlugin(revision = "$Revision: 35036 $", interfaceVersion = 2, names = { "thaicyberupload.com" }, urls = { "http://(www\\.)?(thaicyberupload\\.com/get/|data\\d+\\.thaicyberupload\\.com/dl/)[A-Za-z0-9]+" })
