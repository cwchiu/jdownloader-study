...
@HostPlugin(revision = "$Revision: 38653 $", interfaceVersion = 2, names = { "imgspice.com" }, urls = { "https?://(?:www\\.)?imgspice\\.com/[a-z0-9]{12}" })
public class ImgSpiceCom extends PluginForHost {
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                dllink = new Regex(correctedBR, "\"(https?://[a-z0-9]+\\." + DOMAINS + "/i/[^<>\"]*?)\"").getMatch(0);
            }
            if (dllink == null) {
