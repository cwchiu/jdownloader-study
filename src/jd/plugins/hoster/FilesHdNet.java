...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "fileshd.net" }, urls = { "https?://(?:www\\.)?fileshd\\.net/(?:embed\\-)?[a-z0-9]{12}" })
public class FilesHdNet extends antiDDoSForHost {
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            /* 2017-02-04: Special - check here for errors as dlForm is always present. */
            checkErrors(downloadLink, false);
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            /* 2017-02-04: Modified this RegEx slightly to fit needs */
