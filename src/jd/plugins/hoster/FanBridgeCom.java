...
@HostPlugin(revision = "$Revision: 34675 $", interfaceVersion = 2, names = { "fanbridge.com" }, urls = { "http://(www\\.)?[a-z0-9]+\\.fanbridge\\.com/downloads/file\\.php\\?file_id=\\d+\\&anon=\\d\\&conf_code=[a-z0-9]+" }) 
