...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "top4upload.com" }, urls = { "https?://(?:www\\.)?top4upload\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class Top4UploadCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://top4upload.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:top4upload\\.com)";
    ...
    public Top4UploadCom(PluginWrapper wrapper) {
        super(wrapper);
