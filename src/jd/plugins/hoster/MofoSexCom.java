 ...
 *
 */
@HostPlugin(revision = "$Revision: 38297 $", interfaceVersion = 3, names = { "mofosex.com" }, urls = { "https?://(www\\.)?mofosex\\.com/(videos/\\d+/[a-z0-9\\-]+\\.html|embed\\?videoid=\\d+|embed_player\\.php\\?id=\\d+)" })
