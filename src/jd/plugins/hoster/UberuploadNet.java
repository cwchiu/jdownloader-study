...
@HostPlugin(revision = "$Revision: 36584 $", interfaceVersion = 2, names = { "uberupload.net" }, urls = { "https?://(?:www\\.)?uberupload\\.net/[A-Za-z0-9]+" })
public class UberuploadNet extends PluginForHost {

    public UberuploadNet(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * captchatype: 2017-03-30: null<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://uberupload.net";
    private final String                   domains                                      = "(uberupload\\.net)";
    ...
    private static final String            url_ERROR_PREMIUMONLY                        = "(.+e=You\\+must\\+register\\+for\\+a\\+premium\\+account\\+to.+|.+/register\\..+|.+\\?e=You\\+must\\+be\\+a\\+paid\\+user\\+to\\+download\\+this)";
