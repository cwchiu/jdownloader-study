...
@HostPlugin(revision = "$Revision: 36886 $", interfaceVersion = 2, names = { "we4load.com" }, urls = { "https?://(?:www\\.)?we4load\\.com/(?!folder)[A-Za-z0-9]+" })
public class We4loadCom extends antiDDoSForHost {
    public We4loadCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods:<br />
     * limit-info: 2017-05-23: Premium untested, set FREE account limits<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://we4load.com";
    private final String                   domains                                      = "(we4load\\.com)";
