...
@HostPlugin(revision = "$Revision: 38476 $", interfaceVersion = 3, names = { "auroravid.to" }, urls = { "http://(?:www\\.)?(?:(novamov\\.com|novaup\\.com|auroravid\\.to)/(?:download|sound|video)/[a-z0-9]+|(?:embed\\.)?(novamov\\.com|auroravid\\.to)/embed(\\.php|/)(\\?width=\\d+\\&height=\\d+\\&|\\?)v=[a-z0-9]+)" })
