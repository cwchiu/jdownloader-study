...
@HostPlugin(revision = "$Revision: 36027 $", interfaceVersion = 2, names = { "filehost.net" }, urls = { "https?://(?:www\\.)?filehost\\.net/[A-Za-z0-9]+" })
public class FilehostNet extends PluginForHost {
     ...
     * mods:<br />
     * limit-info: 2017-02-04: Premium untested, set FREE account limits<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://filehost.net";
    private final String                   domains                                      = "(filehost\\.net)";
