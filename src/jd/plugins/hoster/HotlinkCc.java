...
@HostPlugin(revision = "$Revision: 36755 $", interfaceVersion = 3, names = { "hotlink.cc" }, urls = { "https?://(?:www\\.)?hotlink\\.cc/(?:embed\\-)?[a-z0-9]{12}" })
public class HotlinkCc extends antiDDoSForHost {
     ...
     * limit-info: 2017-04-11: Premium untested, set FREE account limits<br />
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (inValidate(fileInfo[0])) {
            fileInfo[0] = new Regex(correctedBR, "glyphicon-download\"></i> *([^<>\"]*?)</span>").getMatch(0);
        }
