...
@HostPlugin(revision = "$Revision: 35516 $", interfaceVersion = 2, names = { "empflix.com" }, urls = { "https?://(?:www\\.)?empflix\\.com/(?:view\\.php\\?id=\\d+|videos/.*?\\-\\d+\\.html|.+/video\\d+)|https?://(?:www\\.)?empflix\\.com/embedding_player/embedding_feed\\.php\\?viewkey=[a-z0-9]+|https?://player\\.empflix\\.com/video/\\d+" })
