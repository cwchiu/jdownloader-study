...
@HostPlugin(revision = "$Revision: 35797 $", interfaceVersion = 3, names = { "fuqer.com" }, urls = { "https?://(?:www\\.)?fuqer\\.com/videos/[a-z0-9\\-]+\\-\\d+\\.html" })
public class FuqerCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        final Regex urlinfo = new Regex(link.getDownloadURL(), "/videos/([a-z0-9\\-]+)\\-(\\d+)\\.html");
        final String url_filename = urlinfo.getMatch(0);
