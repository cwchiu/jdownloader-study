...
@HostPlugin(revision = "$Revision: 35231 $", interfaceVersion = 2, names = { "wipfiles.net" }, urls = { "https?://(www\\.)?wipfiles\\.net/(vidembed\\-)?[a-z0-9]{12}" })
public class WipFilesNet extends antiDDoSForHost {
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = new Regex(correctedBR, "id=\"countdown\">[^<>\"]+<span class=\"[^<>\"]+\">(\\d+)</span>").getMatch(0);
        if (ttt != null) {
