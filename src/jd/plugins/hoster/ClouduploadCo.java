...
@HostPlugin(revision = "$Revision: 38085 $", interfaceVersion = 3, names = { "cloudupload.co" }, urls = { "https?://(?:www\\.)?cloudupload\\.co/(?:embed\\-)?[a-z0-9]{12}" })
public class ClouduploadCo extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://cloudupload.co".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:cloudupload\\.co)";
    ...
    public ClouduploadCo(PluginWrapper wrapper) {
        super(wrapper);
