...
@HostPlugin(revision = "$Revision: 37874 $", interfaceVersion = 2, names = { "grifthost.com" }, urls = { "https?://(www\\.)?grifthost\\.com/((vid)?embed\\-)?[a-z0-9]{12}" })
public class GriftHostCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>(File|Video) Not Found<|>The file was removed by|Reason for deletion:\n)").matches()) {
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "VIDEONAME\\s*:\\s*(.*?)\\s*</font>").getMatch(0);
            if (fileInfo[0] == null) {
