...
@HostPlugin(revision = "$Revision: 37353 $", interfaceVersion = 3, names = { "vidto.me", "vidtome.co" }, urls = { "https?://(www\\.)?vidto\\.me/((vid)?embed\\-)?[a-z0-9]{12}", "https?://(www\\.)?vidtome\\.co/((vid)?embed\\-)?[a-z0-9]{12}" })
