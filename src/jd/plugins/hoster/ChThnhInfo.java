...
@HostPlugin(revision = "$Revision: 35559 $", interfaceVersion = 2, names = { "chauthanh.info" }, urls = { "http://(www\\.)?chauthanh\\.info/(animeDownload/(download|new)/\\d+/[^<>\"/]+/[^<>\"/]+|animeOST/download/[a-z0-9\\-_]+/[a-z0-9\\-_\\.]+|anime/download/[^<>\"]+\\.html)" })
