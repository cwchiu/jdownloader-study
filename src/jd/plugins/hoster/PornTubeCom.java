...
@HostPlugin(revision = "$Revision: 38498 $", interfaceVersion = 2, names = { "porntube.com" }, urls = { "https?://(www\\.)?(porntube\\.com/videos/[a-z0-9\\-]+_\\d+|embed\\.porntube\\.com/\\d+|porntube\\.com/embed/\\d+)" })
