...
@HostPlugin(revision = "$Revision: 37958 $", interfaceVersion = 3, names = { "it.dplay.com", "dplay.se", "dplay.dk" }, urls = { "https?://it\\.dplay\\.com/.+|https?://it\\.dplay\\.com/\\?p=\\d+", "http://(?:www\\.)?dplay\\.se/.+|https?://(?:www\\.)?dplay\\.se/\\?p=\\d+", "http://(?:www\\.)?dplay\\.dk/.+|https?://(?:www\\.)?dplay\\.dk/\\?p=\\d+" })
