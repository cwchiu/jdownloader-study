...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 3, names = { "toplexil.com" }, urls = { "https?://(?:www\\.)?toplexil\\.com/(?:embed\\-)?[a-z0-9]{12}" }) 
public class ToplexilCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://toplexil.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(toplexil\\.com)";
    ...
    public ToplexilCom(PluginWrapper wrapper) {
        super(wrapper);
