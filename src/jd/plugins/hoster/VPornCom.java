...
@HostPlugin(revision = "$Revision: 38071 $", interfaceVersion = 2, names = { "vporn.com" }, urls = { "https?://(www\\.)?vporn\\.com/(embed|(?!favorite|submitted|(all)?subscriptions|user)[a-z0-9\\-_]+/[a-z0-9\\-_]+)/\\d+" })
