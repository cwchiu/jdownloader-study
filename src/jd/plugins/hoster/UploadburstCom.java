...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "uploadburst.com" }, urls = { "https?://(?:www\\.)?uploadburst\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class UploadburstCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://uploadburst.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:uploadburst\\.com)";
    ...
    public UploadburstCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getFilesizeViaAvailablecheckAlt(final Browser br, final DownloadLink dl) {
        ...
        try {
            ...
            if (SUPPORTS_AVAILABLECHECK_ALT_FAST) {
                /* 2018-02-09: Special: 'check_files' instead of 'checkfiles' */
