...
@HostPlugin(revision = "$Revision: 35599 $", interfaceVersion = 3, names = { "zorofiles.com" }, urls = { "https?://(www\\.)?zorofiles\\.com/(embed\\-)?[a-z0-9]{12}" })
public class ZorofilesCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(File Not Found|No such file|>Oops! Something went wrong|Reason for deletion:\n|>The file expired)|>The file was removed").matches()) {
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /* Ticket Time */
        String ttt = new Regex(correctedBR, "id=\"countdown_str\">[^<>\"]*<span id=\"[^<>\"]+\"(?: class=\"[^<>\"]+\")?>\\s*(\\d+)([\n ]+)?</span>").getMatch(0);
        if (ttt == null) {
