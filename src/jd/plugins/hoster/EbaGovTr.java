...
@HostPlugin(revision = "$Revision: 34675 $", interfaceVersion = 3, names = { "eba.gov.tr" }, urls = { "https?://(www\\.)?(eba\\.gov\\.tr/(video/izle/[a-z0-9]+|ses/dinle/[a-z0-9]+|gorsel/bak/[a-z0-9]+)|ebadecrypted\\.gov\\.tr/dergi/goster/\\d+)" }) 
