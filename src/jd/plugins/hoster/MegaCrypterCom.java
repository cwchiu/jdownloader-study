...
@HostPlugin(revision = "$Revision: 37816 $", interfaceVersion = 3, names = { "megacrypter" }, urls = { "https?://(?:www\\.)?(megacrypter\\.noestasinvitado\\.com|youpaste\\.co|shurcrypter\\.se)/(!|%21)[A-Za-z0-9\\-_\\!%]+" })
