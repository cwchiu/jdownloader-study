...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "uploadbank.com" }, urls = { "https?://(?:www\\.)?uploadbank\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class UploadbankCom extends PluginForHost {
     ...
     * mods:<br />
     * limit-info: 2016-12-29: No limits at all.<br />
    ...
    @SuppressWarnings("deprecation")
    public UploadbankCom(PluginWrapper wrapper) {
        super(wrapper);
