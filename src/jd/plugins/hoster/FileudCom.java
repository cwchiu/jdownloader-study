...
@HostPlugin(revision = "$Revision: 36558 $", interfaceVersion = 2, names = { "fileud.com" }, urls = { "https?://(?:www\\.)?fileud\\.com/[A-Za-z0-9]+" })
public class FileudCom extends PluginForHost {

    public FileudCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://fileud.com";
    private final String                   domains                                      = "(fileud\\.com)";
