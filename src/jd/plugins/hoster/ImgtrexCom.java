...
@HostPlugin(revision = "$Revision: 37219 $", interfaceVersion = 2, names = { "imgtrex.com" }, urls = { "https?://(www\\.)?imgtrex\\.com/(embed\\-)?[a-z0-9]{12}" })
public class ImgtrexCom extends PluginForHost {
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            ...
            dllink = new Regex(correctedBR, "<a href=\"(https?://[^<>\"]*?)\" download").getMatch(0);
        }
        if (dllink == null) {
