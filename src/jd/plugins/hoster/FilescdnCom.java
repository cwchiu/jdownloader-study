...
@HostPlugin(revision = "$Revision: 38342 $", interfaceVersion = 3, names = { "filescdn.com" }, urls = { "https?://(www\\.)?filescdn\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class FilescdnCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "https://filescdn.com";
