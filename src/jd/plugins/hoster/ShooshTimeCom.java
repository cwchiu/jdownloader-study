...
@HostPlugin(revision = "$Revision: 37699 $", interfaceVersion = 2, names = { "shooshtime.com" }, urls = { "https?://(www\\.)?shooshtime\\.com/(videos/(?:[A-Za-z0-9\\-_]+/)?[A-Za-z0-9\\-_]+/|webcam\\-girls/[A-Za-z0-9\\-_]+/)" })
public class ShooshTimeCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (!br.containsHTML("shooshtime\\.com") | br.containsHTML("<h1></h1>")) { // !br.containsHTML("id=\"player\"") | removed
