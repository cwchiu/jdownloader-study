...
@HostPlugin(revision = "$Revision: 37992 $", interfaceVersion = 2, names = { "streaminporn.xyz" }, urls = { "https?://(?:www\\.)?streaminporn\\.xyz/(?:plugins/mediaplayer/site/_embed\\.php\\?u=)?[A-Za-z0-9]+" })
