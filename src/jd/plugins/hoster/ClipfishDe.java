...
@HostPlugin(revision = "$Revision: 36028 $", interfaceVersion = 3, names = { "clipfish.de" }, urls = { "http://(?:www\\.)?clipfish\\.de/(?:.*?channel/\\d+/video/\\d+|video/\\d+(?:/.+)?|special/.*?/video/\\d+|musikvideos/video/\\d+(?:/.+)?)" })
