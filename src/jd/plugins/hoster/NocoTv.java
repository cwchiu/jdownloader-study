...
@HostPlugin(revision = "$Revision: 37344 $", interfaceVersion = 2, names = { "noco.tv" }, urls = { "https?://(?:www\\.)?online\\.nolife\\-tv\\.com/emission/#(!|%21)/\\d+/[a-z0-9\\-_]+|https?://(?:www\\.)?noco\\.tv/emission/\\d+/.+" })
