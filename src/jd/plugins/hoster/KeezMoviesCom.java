...
@HostPlugin(revision = "$Revision: 38316 $", interfaceVersion = 2, names = { "keezmovies.com" }, urls = { "https?://(www\\.)?(keezmovies\\.com/embed_player\\.php\\?v?id=\\d+|keezmoviesdecrypted\\.com/video/[\\w\\-]+)" })
