...
@HostPlugin(revision = "$Revision: 37144 $", interfaceVersion = 2, names = { "hostingrill.co" }, urls = { "https?://(?:www\\.)?hostingrill\\.co/[A-Za-z0-9]+" })
public class HostingrillCo extends PluginForHost {

    public HostingrillCo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://hostingrill.co";
    private final String                   domains                                      = "(hostingrill\\.co)";
