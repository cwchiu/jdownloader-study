...
@HostPlugin(revision = "$Revision: 36401 $", interfaceVersion = 3, names = { "nippyspace.com" }, urls = { "https?://(?:www\\.)?nippyspace\\.com/v/[a-z0-9]+" })
public class NippySpaceCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "https://nippyspace.com/terms.html";
    }
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            dllink = "https://" + this.br.getHost() + dllink;
        }
