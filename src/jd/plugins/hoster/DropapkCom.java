...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "dropapk.com" }, urls = { "https?://(?:www\\.)?dropapk\\.com/(?:embed\\-)?[a-z0-9]{1,12}" })
public class DropapkCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://dropapk.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(dropapk\\.com)";
    ...
    /* Supported linktypes */
    private final String                   TYPE_EMBED                         = "https?://[A-Za-z0-9\\-\\.]+/embed\\-[a-z0-9]{1,12}";
    private final String                   TYPE_NORMAL                        = "https?://[A-Za-z0-9\\-\\.]+/[a-z0-9]{1,12}";
    ...
    /**
     * DEV NOTES XfileSharingProBasic Version 2.7.2.7<br />
     * mods: Website changed from YetiShare to XFS - old urls are still valid so FUIDs in URL can be shorter (and can contain uppercase)
     * than standard XFS [a-z0-9]{12}!<br />
     * limit-info:<br />
