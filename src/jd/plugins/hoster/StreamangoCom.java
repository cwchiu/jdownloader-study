...
@HostPlugin(revision = "$Revision: 38066 $", interfaceVersion = 3, names = { "streamango.com", "streamcherry.com" }, urls = { "https?://(?:www\\.)?streamango\\.com/(?:f|embed)/[a-z0-9]+(?:/[^/]+)?", "https?://(?:www\\.)?streamcherry\\.com/(?:f|embed)/[a-z0-9]+(?:/[^/]+)?" })
