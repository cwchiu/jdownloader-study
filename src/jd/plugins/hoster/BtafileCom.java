...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "btafile.com" }, urls = { "https?://(?:www\\.)?btafile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class BtafileCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://btafile.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(btafile\\.com)";
     ...
     * mods:<br />
     * limit-info: 2017-06-01: Premium untested, set FREE limits<br />
    ...
    public BtafileCom(PluginWrapper wrapper) {
        super(wrapper);
