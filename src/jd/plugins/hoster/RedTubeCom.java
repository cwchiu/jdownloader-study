...
@HostPlugin(revision = "$Revision: 36552 $", interfaceVersion = 2, names = { "redtube.com" }, urls = { "https?://(www\\.)?(redtube\\.(cn\\.com|com|tv|com\\.br)/|embed\\.redtube\\.(cn\\.com|com|tv|com\\.br)/[^<>\"]*?\\?id=)\\d+" })
