...
@HostPlugin(revision = "$Revision: 38455 $", interfaceVersion = 3, names = { "nowvideo.to" }, urls = { "http://(?:www\\.)?(?:nowvideo\\.(?:sx|eu|co|ch|ag|at|ec|li|to)/(?:video/|player\\.php\\?v=|share\\.php\\?id=|embed/\\?v=)|embed\\.nowvideo\\.(sx|eu|co|ch|ag|at)/(embed\\.php|embed/)\\?v=)[a-z0-9]+" })
