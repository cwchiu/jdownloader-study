...
@HostPlugin(revision = "$Revision: 36224 $", interfaceVersion = 3, names = { "wholecloud.net", "epornik.com" }, urls = { "https?://(?:www\\.)?(?:movshare|wholecloud)\\.net/video/[a-z0-9]+|https?://embed\\.movshare\\.net/embed\\.php\\?v=[a-z0-9]+", "https?://(?:www\\.)?epornik\\.com/video/[a-z0-9]+" })
public class MovShareNet extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (br.containsHTML("(The file is beeing transfered to our other servers|This file no longer exists on our servers|>The file does not exist<|file: \"\")")) {
