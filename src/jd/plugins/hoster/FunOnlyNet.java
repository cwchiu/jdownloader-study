...
@HostPlugin(revision = "$Revision: 36496 $", interfaceVersion = 2, names = { "funonly.net" }, urls = { "http://(www\\.)?funonly\\.net/(?:not_)?funny_videos\\.aspx/(?:not_)?funny_video~[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+/video_type~flash/" })
