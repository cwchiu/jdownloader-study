...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "bit-shares.com" }, urls = { "https?://(?:www\\.)?bit\\-shares\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class BitSharesCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://bit-shares.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:bit\\-shares\\.com)";
    ...
    public BitSharesCom(PluginWrapper wrapper) {
        super(wrapper);
