...
@HostPlugin(revision = "$Revision: 36669 $", interfaceVersion = 2, names = { "ultimatedown.com" }, urls = { "https?://(?:www\\.)?ultimatedown\\.com/[A-Za-z0-9]+" })
public class UltimatedownCom extends PluginForHost {

    public UltimatedownCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods: requestFileInformation[Added one special filename RegEx]<br />
     * limit-info: 2017-04-24: Premium untested, set FREE account limits<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://ultimatedown.com";
    private final String                   domains                                      = "(ultimatedown\\.com)";
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            /* 2017-03-24: Special */
            filename = this.br.getRegex("<p class=\"p\\-header\">([^<>\"]+)\\– UltimateDown").getMatch(0);
            if (filename == null) {
