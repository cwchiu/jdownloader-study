...
@HostPlugin(revision = "$Revision: 38646 $", interfaceVersion = 3, names = { "filebebo.com" }, urls = { "https?://(?:www\\.)?filebebo\\.com/(?:embed\\-|d/)?[a-z0-9]{12}" })
public class FilebeboCom extends antiDDoSForHost {
    ...
    private final String         COOKIE_HOST                        = "http://filebebo.com".replaceFirst("https?://", SUPPORTS_HTTPS ? "https://" : "http://");
    private final String         NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private final static String  DOMAINS                            = "(?:filebebo\\.com)";
