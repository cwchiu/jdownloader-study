...
@HostPlugin(revision = "$Revision: 37296 $", interfaceVersion = 3, names = { "kingvid.tv" }, urls = { "https?://(?:www\\.)?kingvid\\.tv/(?:embed\\-)?[a-z0-9]{12}" })
public class KingvidTv extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://kingvid.tv";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(kingvid\\.tv)";
    ...
    public KingvidTv(PluginWrapper wrapper) {
        super(wrapper);
