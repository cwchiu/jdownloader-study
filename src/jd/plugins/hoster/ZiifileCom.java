...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 3, names = { "ziifile.com" }, urls = { "https?://(?:www\\.)?ziifile\\.com/(?:embed\\-)?[a-z0-9]{12}" }) 
public class ZiifileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://ziifile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(ziifile\\.com)";
     ...
     * mods: scanInfo[Removed one filename RegEx]<br />
     * limit-info:<br />
    ...
    public ZiifileCom(PluginWrapper wrapper) {
        super(wrapper);
