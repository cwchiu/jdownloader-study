...
@HostPlugin(revision = "$Revision: 38339 $", interfaceVersion = 2, names = { "primemusic.ru" }, urls = { "https?://(www\\.)?(primemusic\\.ru|prime\\-music\\.net|primemusic\\.cc|primemusic\\.me)/Media\\-page\\-\\d+\\.html" })
