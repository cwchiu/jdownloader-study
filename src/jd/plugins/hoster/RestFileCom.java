...
@HostPlugin(revision = "$Revision: 36420 $", interfaceVersion = 2, names = { "restfilee.com" }, urls = { "https?://(www\\.)?(restfile\\.(ws|ca|co|com|bz|cc|net)|restfiles\\.net|restfilee\\.com)/[a-z0-9]{12}" })
