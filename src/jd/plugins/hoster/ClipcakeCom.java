...
@HostPlugin(revision = "$Revision: 37435 $", interfaceVersion = 3, names = { "clipcake.com" }, urls = { "https?://(?:www\\.)?clipcake\\.com/(?:videos/\\d+/[a-z0-9\\-]+/|embed/\\d+)|https?://m\\.clipcake\\.com/videos/\\d+/[a-z0-9\\-]+/" })
public class ClipcakeCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.clipcake.com/terms.php";
    }
