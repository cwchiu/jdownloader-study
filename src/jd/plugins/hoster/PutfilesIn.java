...
@HostPlugin(revision = "$Revision: 36978 $", interfaceVersion = 2, names = { "putfiles.in" }, urls = { "https?://(?:www\\.)?putfiles\\.in/[A-Za-z0-9]+" })
public class PutfilesIn extends PluginForHost {
    public PutfilesIn(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://putfiles.in";
    private final String                   domains                                      = "(putfiles\\.in)";
