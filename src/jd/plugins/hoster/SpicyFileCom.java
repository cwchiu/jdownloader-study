...
@HostPlugin(revision = "$Revision: 36562 $", interfaceVersion = 2, names = { "spicyfile.com" }, urls = { "https?://(www\\.)?spicyfile\\.com/(vidembed\\-)?[a-z0-9]{12}" })
