...
@HostPlugin(revision = "$Revision: 37606 $", interfaceVersion = 2, names = { "xshare.eu" }, urls = { "https?://(?:www\\.)?xshare\\.eu/[A-Za-z0-9]+" })
public class XshareEu extends antiDDoSForHost {
     ...
     * YetiShareBasic Version 1.1.1-psp<br />
     * mods: fetchAccountInfo[Special premium expire date handling], url_ERROR_WAIT_BETWEEN_DOWNLOADS_LIMIT[Updated this RegEx to handle the
     * language]<br />
     * limit-info:<br />
     * protocol: no https<br />
     * captchatype: 2017-08-01: reCaptchaV2<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://xshare.eu";
    private final String                   domains                                      = "(xshare\\.eu)";
    ...
    private static final String            url_ERROR_WAIT_BETWEEN_DOWNLOADS_LIMIT       = ".*?e=(You\\+must\\+wait\\+.*?|Musisz\\+poczeka%C4%87\\+\\+)";
