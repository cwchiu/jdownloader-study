...
@HostPlugin(revision = "$Revision: 38468 $", interfaceVersion = 3, names = { "bitporno.sx", "raptu.com" }, urls = { "https?://(?:www\\.)?bitporno\\.(?:sx|com)/(\\?v=|v/|embed/)[A-Za-z0-9]+", "https?://(?:www\\.)?(?:playernaut\\.com|rapidvideo\\.com|raptu\\.com)/(?:e(?:mbed)?/|(?:embed/)?\\?v=|v(?:iew)?/)[A-Za-z0-9]+" })
