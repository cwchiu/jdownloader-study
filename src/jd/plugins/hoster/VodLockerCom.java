...
@HostPlugin(revision = "$Revision: 37353 $", interfaceVersion = 3, names = { "vodlocker.city" }, urls = { "https?://(?:www\\.)?vodlocker\\.city/video/\\d+/[^/]+" })
@SuppressWarnings("deprecation")
public class VodLockerCom extends PluginForHost {
    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://vodlocker.city";
    // domain names used within download links.
    private final String               DOMAINS                      = "(vodlocker\\.com|vodlocker\\.city)";
