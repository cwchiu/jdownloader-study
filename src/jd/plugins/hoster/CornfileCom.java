...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "cornfile.com" }, urls = { "https?://(?:www\\.)?cornfile\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class CornfileCom extends antiDDoSForHost {
    ...
    private static final String  COOKIE_HOST                        = "http://cornfile.com";
    private static final String  NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String  DOMAINS                            = "(cornfile\\.com)";
     ...
     * mods: doFree[Extra errorhandling after f1 Form]<br />
     * limit-info: 2017-05-09: All untested because website is broken<br />
    ...
    public CornfileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void doFree(final DownloadLink downloadLink, final boolean resumable, final int maxchunks, final String directlinkproperty) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (download1 != null) {
                ...
                checkErrors(downloadLink, false);
                /* 2017-05-09: Special errorhandling, website is broken */
                if (this.br.getRedirectLocation() != null && !this.br.getRedirectLocation().contains(this.fuid)) {
