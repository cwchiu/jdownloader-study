...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "imggold.org" }, urls = { "https?://(?:www\\.)?imggold\\.org/(?:embed\\-)?[a-z0-9]{12}" })
public class ImggoldOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imggold.org";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imggold\\.org)";
    ...
    @SuppressWarnings("deprecation")
    public ImggoldOrg(PluginWrapper wrapper) {
        super(wrapper);
