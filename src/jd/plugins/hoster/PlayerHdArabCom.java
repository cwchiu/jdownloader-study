...
@HostPlugin(revision = "$Revision: 37145 $", interfaceVersion = 3, names = { "player.hd-arab.com" }, urls = { "https?://(?:www\\.)?player\\.hd\\-arab\\.com/(?:embed\\-)?[a-z0-9]{12}" })
public class PlayerHdArabCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://player.hd-arab.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(player\\.hd\\-arab\\.com)";
     ...
     * mods: scanInfo[Added one filename RegEx]<br />
     * limit-info:<br />
    ...
    @SuppressWarnings("deprecation")
    public PlayerHdArabCom(PluginWrapper wrapper) {
        super(wrapper);
