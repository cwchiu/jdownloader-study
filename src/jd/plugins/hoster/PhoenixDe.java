...
@HostPlugin(revision = "$Revision: 36014 $", interfaceVersion = 3, names = { "phoenix.de", "tivi.de" }, urls = { "decrypted://phoenix\\.de/content/\\d+\\&quality=\\w+|decrypted://(www\\.)?zdf\\.de/ZDFmediathek/[^<>\"]*?beitrag/video/\\d+\\&quality=\\w+", "decrypted://tivi\\.de/content/\\d+\\&quality=\\w+" })
