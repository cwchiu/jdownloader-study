...
@HostPlugin(revision = "$Revision: 37435 $", interfaceVersion = 3, names = { "pornrox.com" }, urls = { "https?://(?:www\\.)?(?:pornrox|pornroxxx)\\.com/videos/\\d+(?:/[a-z0-9\\-]+)?" })
public class PornroxCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "https://www.pornrox.com/legal/terms";
    }
        ...
        if (jssource != null) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    quality_temp = Long.parseLong(new Regex(entry.getKey(), "(\\d+)p").getMatch(0));
