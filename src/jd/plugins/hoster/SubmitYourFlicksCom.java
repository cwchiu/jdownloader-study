...
@HostPlugin(revision = "$Revision: 38489 $", interfaceVersion = 3, names = { "submityourflicks.com" }, urls = { "https?://(www\\.)?submityourflicks\\.com/(\\d+[a-z0-9\\-]+\\.html|embconfig/\\d+|embedded/\\d+)" })
